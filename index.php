...
<!-- head untuk mengambil template css dan js dari bootstrap dan style web dari style.css   -->
<head>
  ...
  <div class="container-xxl">
    ...
    <div class="row" id="content">
      <div class="col">
       ...
       <?php 
       echo "&emsp;LSP BPPTIK adalah lembaga pendukung BNSP yang  bertanggung jawab untuk melaksanakan uji kompetensi dan sertifikasi kompetensi di bidang TIK. LSP BPPTIK didirikan oleh Badan Penelitian dan Pengembangan Sumber Daya Manusia (Balitbang SDM) Kementerian Komunikasi dan Informatika (Kominfo) melalui Surat Keputusan (SK) Kepala Balitbang SDM Nomor 13 Tahun 2018 tanggal 1 Februari 2018 tentang Pembentukan Lembaga Sertifikasi Profesi Pihak Kesatu Balai Pelatihan dan Pengembangan Teknologi Informasi dan Komunikasi"."<br><br>";

        echo "LSP BPPTIK memiliki fungsi melaksanakan sertifikasi kompetensi uji kompetensi, dan sertifikasi bidang TIK, dengan tugas:"."<br><br>";
        $tugas = ["a. menyusun dan mengembangkan skema sertifikasi", "b. membuat perangkat asesmen dan uji kompetensi",
         "c. menyediakan tenaga penguji (asesor)", "d. melaksanakan uji kompetensi dan sertifikasi", "e. melaksanakan surveilan pemeliharaan sertifikasi", "f. menetapkan persyaratan, memverifikasi dan menetapkan Tempat Uji Kompetensi (TUK)", "g. memelihara kinerja asesor dan TUK dan", "mengembangkan pelayanan uji kompetensi dan sertifikasi"];
        foreach ($tugas as $tug){
          echo "&emsp;$tug<br>";
        } 
        echo "<br>";

       echo "&emsp;Dalam melaksanakan fungsi dan tugasnya, LSP BPPTIK mengacu pada pedoman yang dikeluarkan oleh BNSP. Dalam pedoman tersebut ditetapkan persyaratan yang harus dipatuhi untuk menjamin agar lembaga sertifikasi menjalankan sistem sertifikasi secara konsisten dan profesional, sehingga dapat diterima pada tingkat nasional yang relevan demi kepentingan pengembangan sumber daya manusia dalam aspek peningkatan kualitas dan perlindungan tenaga kerja.";
    ?>
        <hr>
