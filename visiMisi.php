  ...
  <div class="container-xxl">
    ...
    <div class="row" id="content">
      <div class="col">
        <p>
        <h3>
          <center>Visi dan Misi LSP BPPTPIK</center>
        </h3>
        <hr>
        ...
        <?php 
        echo "<b>"."A. Visi"."</b>"."<br><br>";

        echo "Menjadi Lembaga Sertifikasi Profesi bidang Teknologi Informasi dan Komunikasi (TIK) terbaik di tingkat nasional, regional, dan internasional."."<br><br>";

        echo "<b>"."B. Misi"."</b>"."<br><br>";

        echo "&emsp;1. Melaksanakan sertifikasi kompetensi kerja di bidang TIK yang independen dan profesional."."<br>";
        echo "&emsp;2. Menjamin mutu pelaksanaan sertifikasi kompetensi kerja sesuai dengan standar yang berlaku."."<br><br>";

        echo "<b>"."C. Sasaran Mutu"."</b>"."<br><br>";

        echo "LSP BPPTIK menetapkan sasaran mutu setiap tahun dengan melakukan pemantauan (monitoring) setiap
        semester."."<br><br>";

        echo "Sasaran mutu tersebut mencakup:"."<br><br>";

        $sasaran = ["1. Jumlah pengguna layanan;", "2. Tingkat kepuasan layanan;", "3. Jumlah banding;", "4. Jumlah keluhan; dan", "5. capaian standar waktu proses sertifikasi."];
        foreach($sasaran as $sasar){
          echo "&emsp;$sasar<br>";
        }
        ?>
